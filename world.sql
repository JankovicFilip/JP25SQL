...
CREATE SCHEMA world character set utf8;
USE world;
SET AUTOCOMMIT=0;

# mysql -uedunova -pedunova --default_character_set=utf8 < d:\JP25\Zavrsni-rad-ideja\world.sql
...
delete from city where ID=9999;
